...
> **Note:** If deploying SvelteKit on Netlify, use `_redirects` file placed inside your `static` folder as redirects inside `netlify.toml` are [not supported](https://docs.netlify.com/frameworks/sveltekit/#limitations).
